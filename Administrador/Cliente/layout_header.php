...
<body>
  ...
  <nav id="sb">
    <div class="sb-head">
      <div class="logo-c"><img src="../Cliente/logo.jpeg" style="width:34px;height:34px;border-radius:50%;object-fit:cover;" onerror="this.style.display='none';this.parentElement.textContent='⚙'"></div>
