...
<div class="stat-grid">
  <div class="sc sc-teal">
    <div>
      ...
      <a href="index.php" class="sc-more" style="color:rgba(255,255,255,.85)">Ver clientes <i class="fas fa-arrow-right"></i></a>
    </div>
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:20px">
  ...
  <div class="tcard">
    <div class="tcard-hdr">
      ...
      <a href="index.php" class="btn btn-sm btn-primary">Ver todos</a>
    </div>
    <table>
