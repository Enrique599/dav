...
<div class="tcard">
  ...
  <table>
    <thead>
      <tr><th>ID</th><th>Nombre</th><th>Apellido</th><th>Teléfono</th><th>Dirección</th><th>Rol</th><th>Eliminar</th></tr>
    </thead>
    <tbody>
    <?php
    $num = 0;
    ...
    <?php endwhile; ?>
    <?php if($num===0): ?>
    <tr><td colspan="7" style="text-align:center;color:var(--muted);padding:24px">No hay empleados registrados. Agrega el primero arriba.</td></tr>
    <?php endif; ?>
    </tbody>
  </table>
</div>
