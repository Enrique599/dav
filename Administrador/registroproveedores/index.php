    ...
    <tbody>
      ...
      ?>
        <tr>
          ...
          <td>
            <a href="modificar.php?id=<?php echo $row['Id_proovedor']; ?>" class="ib ib-edit">
          ...
          <td>
            <a href="index.php?del=<?php echo $row['Id_proovedor']; ?>" class="ib ib-del"
              ...
              <i class="fas fa-times" style="color: #ff3333;"></i>
            </a>
          </td>
        </tr>
      <?php endwhile; ?>
      <?php if ($num === 0): ?>
        <tr>
          <td colspan="6" style="text-align:center;color:var(--muted);padding:24px">No hay proveedores registrados.</td>
        </tr>
      <?php endif; ?>
    </tbody>
  </table>
